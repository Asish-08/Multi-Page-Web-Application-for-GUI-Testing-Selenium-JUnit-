...
public class V1petstoreTest {
    ...
    public void homepageTest() {
        driver.get("http://127.0.0.1:5502/index_v2.html");
    ...
    public void browsePageTest() {
        driver.get("http://127.0.0.1:5502/browse_v2.html");
        driver.manage().window().setSize(new Dimension(1430, 805));
    ...
    public void favoritesPageTest() {
        driver.get("http://127.0.0.1:5502/favorites_v2.html");
        driver.manage().window().setSize(new Dimension(1430, 805));
    ...
    public void contactPageTest() {
        driver.get("http://127.0.0.1:5502/contact_v2.html");
        driver.manage().window().setSize(new Dimension(1430, 805));
